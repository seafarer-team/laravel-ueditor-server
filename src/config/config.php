...
return [
	...
	'upload' => [
		...
		"imageUrlPrefix"=> $imgBaseUrl, /* 图片访问路径前缀 */
		...
		"catcherUrlPrefix"=> $imgBaseUrl, /* 图片访问路径前缀 */
		...
		"videoUrlPrefix"=> $imgBaseUrl, /* 视频访问路径前缀 */
		...
		"fileUrlPrefix"=> $imgBaseUrl, /* 文件访问路径前缀 */
		...
		"imageManagerUrlPrefix"=> $imgBaseUrl, /* 图片访问路径前缀 */
		...
		"fileManagerUrlPrefix"=> $imgBaseUrl, /* 文件访问路径前缀 */
